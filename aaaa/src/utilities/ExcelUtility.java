...
public class ExcelUtility {
	...
	public void fetchTestCaseData(int rowNumber) throws Exception
	{
		...
		String Server = GlobalVar.serverName;
		Server=Server.toUpperCase()+"_TestData";
		System.out.println("Server"+Server);
		System.out.println("excel"+GlobalVar.TestexcelPath);
		rowData=Utility.getOdsSheetData(GlobalVar.TestexcelPath,Server,rowNumber);			
	...
	public String getCellValueByCollumAndRowHeader(String colHeader, String rowHeader,int sheetNumber) throws Exception {
		String value = "";
         int colNumber;
         int rowNumber;
		Workbook workbook = null;
	...
	public static void main(String args[]) throws Exception{
		...
		HashMap< String, String> testData=eu.getStockDataFromExcel("D:\\Crestech-Data\\ETProject\\ETPortFolioMobileAutomation\\TestRepository\\TestData\\ET-Stocks.xls");
